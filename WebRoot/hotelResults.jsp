                ...
                <select name="searchType" class="form-control select select-info select-block mbl" style="min-width:90px" >
                  <c:choose>
                    <c:when test="${page.searchType eq '餐厅'}">
                      <option value="餐厅" selected="selected">餐厅</option>
                      <option value="菜名">菜品</option>
                    </c:when>
                    <c:otherwise>
                     <option value="餐厅">餐厅</option>
                     <option value="菜名" selected="selected">菜品</option>
                    </c:otherwise>
                    </c:choose>
                </select>
            </div>
        ...
        <div class="row">
            <table id="hotel_table" class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="hotelInfo.do?hotelId=${hotel.hotelId}" type="button" class="btn btn-default btn-primary">详情</a>
                    </td>
                </tr>
                </c:forEach>
            </table>
