    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-1" style="margin-top: 16px;">
                <select name="searchType" class="form-control select select-info select-block mbl" style="min-width:90px" onchange="document.getElementById('search').submit()" >
            ...
            <div class="col-lg-1" style="margin-top: 16px; margin-left: 21px;">
                <select name="order" class="form-control select select-info select-block mbl" style="min-width:90px" onchange="document.getElementById('search').submit()" >
                    <!--<option style="display: none" value="<%=request.getSession().getAttribute("complex")%>" selected><%=request.getSession().getAttribute("complex").toString()%></option>-->
        ...
        <div class="row">
            ...
            <table id="hotel_table" class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>34521</td>
                    <td>
                        <a href="#" type="button" class="btn btn-default btn-primary">详情</a>
                    </td>
                </tr>
                <tr>
                    <td></td>
